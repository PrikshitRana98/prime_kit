...
const Header = () => {
    return (
        <header style={{ background: "white", width: "100%", height: "85px",padding:"0px 150px" }} className="d-flex align-items-center justify-content-between">
            <Link to="/home"><img src={Logo} alt="PrimeKit_Logo" height={25}/></Link>
